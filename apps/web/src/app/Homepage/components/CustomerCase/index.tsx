...
import dehero from 'src/assets/images/homepage/dehero-side.png';
import gate3 from 'src/assets/images/homepage/gate3-side.png';
import unipass from 'src/assets/images/homepage/unipass-side.png';
