...
export const getChanList = () =>
  request.get("chan/list", {}) as Promise<Array<ChanItem>>;
 ...
 * @description 创建物料
 */
export const createMaterial = (params: MaterialItem) =>
  request.post("activity/create", params) as Promise<number>;
...
export const getActivityList = () =>
  request.get("activity/list", {}) as Promise<Array<ReturnRemandItem>>;

export const getActivityListBystatus = (
  params: getActivityListBystatusRequestParams
) =>
  request.post("activity/record/list", params) as Promise<{
    num: number;
    list: Array<ReturnRemandItem>;
  }>;
 ...
 * @description 更新需求信息
 */
export const updateActivity = (params: AllMaterialItem) =>
  request.post("activity/update", params) as Promise<unknown>;
...
export const getActivityById = (id: number) =>
  request.get("activity/get", { id }) as Promise<ReturnRemandItem>;
